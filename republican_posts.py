...
with open('republican_all.csv', 'rb') as csvfile:
...
with open('republican_comments.csv', 'rb') as csvfile:
...
with open('republican_day.csv', 'wb') as csvfile:
...
with open('republican_week.csv', 'wb') as csvfile:
